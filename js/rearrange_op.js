...
function showRearrangeBar(){  
  ...
  function showAPTRearrangeBar(){
    ...
    $(".btn-outline-primary").css('font-size', '0.85em')
    $(".btn-outline-primary").css('padding', '6px, 4px, 6px, 4px')
    $(".btn-outline-primary").css('border', '1px solid white')
  ...
  function showRegionRearrangeBar(){
    $(".btn-outline-primary").css('font-size', '0.85em')    
    $(".btn-outline-primary").css('padding', '1px, 1px, 1px, 1px')
    $(".btn-outline-primary").css('border', '1px solid white')
