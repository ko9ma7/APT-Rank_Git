...
function showPART(){
    ...
    titleHtml += "<div id='part_title'>"        
        ...
        titleHtml += "</div>"
        titleHtml +="<div style='text-align:center; align-self:center'><div class='image_wrap'><img src='./ad/image/" + shop_icon + "' height='70px' alt='' style='clip-path: circle(45%)'></div></div>"
    titleHtml += "</div>"    
