...
function showPART(){
    ...
    titleHtml += "<div id='part_title'>"        
        ...
        titleHtml += "</div>"
        titleHtml +="<div style='text-align:center; align-self:center'><div class='image_wrap' style='clip-path: circle(50px at center)'><img src='./ad/" + shop_icon + "' height='55px'></div></div>"
    titleHtml += "</div>"    
